About aws-cdk.cx-api-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aws-cdk.cx-api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-cdk.cx-api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aws-cdk.cx-api
# for installing globally
pixi global install aws-cdk.cx-api
```
...
It is possible to list all of the versions of `aws-cdk.cx-api` available on your platform:
...
```
pixi search aws-cdk.cx-api --channel conda-forge
```
